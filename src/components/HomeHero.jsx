  ...
  return (
    <section className='hero text-center p-lg-4 p-2' id='home'>
      ...
      <div className="blur2 d-none d-sm-none d-md-block"></div>
          ...
          <p className='p-2 text-black bg-white rounded-5 mb-3 mt-3'>Data Analytics  Bootcamp</p>
        <h1 className="heading-text  text-white mt-3 text-900 py-2">Secret Blueprint for  High-Paid <span className="text-main">Data Analytics career</span></h1>
        <div className="p-large text-white">Live Q&A Session With Experts, <br />Get Easiest Part To Learn complete Data Analytics,  Get E-Certificate and Study Meterial</div>
